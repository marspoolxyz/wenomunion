...
describe("Test Sample contract", async function () {
  ...
  describe("Contracts", async function () {
    ...
    it("Deploy contract", async function () {
      const INIT_STATE = 0;
      const deployerSigner = (await locklift.keystore.getSigner("0"))!;
      ...
      expect(
        await locklift.provider.getBalance(sample.address)
    ...
    //   locklift.tracing.setAllowedCodesForAddress(
    //     sample.address, { compute: [102] });
